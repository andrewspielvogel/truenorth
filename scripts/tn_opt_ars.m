...
%  
  ...
  TrueNorth_Package_dir = '/home/lcsr/sentry_cruise_ws/src/truenorth'

  % exp dir with subdirectories /kvh, /phine, and /proc
  EXP_dir = '/home/lcsr/cruise_data/dives_10hz/sentry494'

  % name of expt file with no suffix such as 2018_08_21_12_45'
  LOG_in_fn  = 'dive_10hz_bottom'
  LOG_out_fn = 'dive_10hz_bottom_expt02'
  HZ = '10'
  ...
  % KVH inpu file name 
  KVH    =[EXP_dir '/kvh/' LOG_in_fn '_dvl.KVH'];
  ...
  sim_cmd = ['/home/lcsr/sentry_cruise_ws/devel/lib/truenorth/post_process ' CONFIG];
  fprintf(1,'tn_opt: executing command: %s\n', sim_cmd);
  % execute the command
