function [err KVH PHINS CSV CONFIG PDF EXP_dir TrueNorth_Package_dir] = tn_opt_llw_494_survey(p)
% 2018-10-10 LLW revised to return file names in additional output arguments
