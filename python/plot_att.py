...
def main(argv):
    ...
    plt.subplot(311)
    plt.plot(t,data[:,2]*180.0/math.pi-data[:,5]*180.0/math.pi)
    plt.ylabel('Roll (degrees)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,t[-1], -10, 10])
    plt.grid(True)
    plt.subplot(312)
    plt.plot(t,data[:,3]*180.0/math.pi-data[:,6]*180.0/math.pi)
    plt.ylabel('Pitch (degrees)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,t[-1], -10, 10])
    plt.grid(True)
    plt.subplot(313)
    plt.plot(t,data[:,4]*180.0/math.pi-data[:,7]*180.0/math.pi)
    plt.ylabel('Heading (degrees)')
    plt.xlabel('Seconds (s)')
    #plt.axis([0,t[-1], -10, 10])
    plt.grid(True)
    ...
    plt.xlabel('Seconds (s)')
    #plt.axis([0,t[-1], -3./100000., 3./100000.])
