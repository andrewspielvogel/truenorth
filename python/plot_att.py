...
def main(argv):
    ...
    plt.xlabel('Seconds (s)')
    plt.axis([0,data.as_matrix([1])[-1]-data.as_matrix([1])[0], -25., 25.])
    plt.grid(True)
    ...
    plt.ylabel('x (g)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,data.as_matrix([1])[-1]-data.as_matrix([1])[0], -0.2, 0.2])
    plt.grid(True)
    plt.subplot(312)
    ...
    plt.subplot(311)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([23]))
    plt.ylabel('x (g)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,data.as_matrix([1])[-1]-data.as_matrix([1])[0], -0.2, 0.2])
    plt.grid(True)
    plt.subplot(312)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([24]))
    plt.ylabel('y (g)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,data.as_matrix([1])[-1]-data.as_matrix([1])[0], -0.2, 0.2])
    plt.grid(True)
    plt.subplot(313)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([25]))
    plt.ylabel('z (g)')
    plt.xlabel('Seconds (s)')
    plt.axis([0,data.as_matrix([1])[-1]-data.as_matrix([1])[0], -1.2, 1.2])
    plt.grid(True)
    ...
    plt.subplot(311)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([26]))
    plt.ylabel('x (rad/s)')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    plt.subplot(312)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([27]))
    plt.ylabel('y (rad/s)')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    plt.subplot(313)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([28]))
    plt.ylabel('z (rad/s)')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    ...
    plt.subplot(311)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([29]))
    plt.ylabel('x')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    plt.subplot(312)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([30]))
    plt.ylabel('y')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    plt.subplot(313)
    plt.plot(data.as_matrix([1])-data.as_matrix([1])[0],data.as_matrix([31]))
    plt.ylabel('z')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    ...
    plt.figure(10)
    plt.suptitle('MAG Measurement')
    plt.plot(data.as_matrix([30]),data.as_matrix([29]))
    plt.ylabel('y')
    plt.xlabel('x')
    plt.axis('equal')
    plt.grid(True)
