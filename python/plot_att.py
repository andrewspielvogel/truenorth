...
def main(argv):
    ...
    plt.figure(111)
    plt.suptitle('IMU Temp')
    plt.plot(t,data[:,32])
    plt.ylabel('Temp (C)')
    plt.xlabel('Seconds (s)')
    plt.grid(True)
    pp.savefig(plt.figure(111))
    plt.close("all")
    ...
    plt.figure(112)
    plt.suptitle('w_E_n error')
    plt.subplot(411)
    plt.plot(t,data[:,33]*180./math.pi)
    plt.xlabel('Seconds (s)')
    plt.ticklabel_format(axis='y', style='sci', scilimits=(-2, 2))
    plt.grid(True)
    plt.subplot(412)
    plt.plot(t,data[:,34]*180./math.pi)
    plt.xlabel('Seconds (s)')
    plt.ticklabel_format(axis='y', style='sci', scilimits=(-2, 2))
    plt.grid(True)
    plt.axis([0,t[-1], -7, 7])
    plt.subplot(413)
    plt.plot(t,data[:,35]*180./math.pi)
    plt.xlabel('Seconds (s)')
    plt.ticklabel_format(axis='y', style='sci', scilimits=(-2, 2))
    plt.grid(True)
    plt.subplot(414)
    plt.plot(t,data[:,36]*180./math.pi)
    plt.xlabel('Seconds (s)')
    plt.ylabel('MAGNITUDE (degrees)')
    plt.axis([0,t[-1], 0, 7])
    plt.ticklabel_format(axis='y', style='sci', scilimits=(-2, 2))
    plt.grid(True)
    pp.savefig(plt.figure(112))
    plt.close("all")
